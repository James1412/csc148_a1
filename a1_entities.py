...
class Person(PersonSprite):
    ...
    def __init__(self, start: int, target: int) -> None:
        ...
        NOTE: Initialize all Person instance attributes BEFORE
        calling PersonSprite.__init__.
        This is because the PersonSprite initializer will call
         get_anger_level, which
    ...
    def __repr__(self) -> str:
        ...
        This function is a special method that displays a custom string when an
        object
        of this type is evaluated in the Python console. It is provided for you
         for
        ...
        """
        return f'Person(start={self.start},' \
               f' target={self.target}, wait_time={self.wait_time})'
...
class Elevator(ElevatorSprite):
    ...
    def __init__(self, capacity: int) -> None:
        ...
        Elevators always start with a current and target floor of 1,
         and no passengers.
    ...
    def fullness(self) -> float:
        ...
        0.0
        >>> my_elevator2 = Elevator(2)
        >>> my_elevator2.add_passenger(Person(1, 2))
        >>> my_elevator2.add_passenger(Person(2, 3))
        >>> my_elevator2.fullness()
        1.0
        >>> my_elevator3 = Elevator(4)
        >>> my_elevator3.add_passenger(Person(1, 2))
        >>> my_elevator3.add_passenger(Person(2, 3))
        >>> my_elevator3.fullness()
        0.5
        """
        number_of_passenger = len(self.passengers)
        return number_of_passenger / self.capacity
...
if __name__ == '__main__':
    ...
    # a1_entities" or "Run File in Python Console".
    #
    # python_ta will check your work and open up your web browser to display
    # its report. For full marks, you must fix all issues reported, so that
    # you see "None!" under both "Code Errors"
    # and "Style and Convention Errors".
    # TIP: To quickly uncomment lines in PyCharm
    # , select the lines below and press
    # "Ctrl + /" or "⌘ + /".
    import python_ta
